...
TaskAssignment _$TaskAssignmentFromJson(Map<String, dynamic> json) =>
    TaskAssignment(
      ...
      task: json['task'] == null
          ? null
          : TaskAssignmentTask.fromJson(json['task'] as Map<String, dynamic>),
...
TaskAssignmentTask _$TaskAssignmentTaskFromJson(Map<String, dynamic> json) =>
    TaskAssignmentTask(
      id: json['id'] as String?,
...
Map<String, dynamic> _$TaskAssignmentTaskToJson(TaskAssignmentTask instance) =>
    <String, dynamic>{
      'id': instance.id,
...
TaskAssignmentProvider _$TaskAssignmentProviderFromJson(
...
Map<String, dynamic> _$TaskAssignmentProviderToJson(
  TaskAssignmentProvider instance,
) => <String, dynamic>{
  'id': instance.id,
...
Map<String, dynamic> _$ProviderLocationToJson(ProviderLocation instance) =>
    <String, dynamic>{
      'id': instance.id,
