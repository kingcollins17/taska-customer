...
class _TasksClient implements TasksClient {
  ...
  Future<GenericResponse<PriceAdjustment>> respondToPriceAdjustment(
    String taskId,
    String adjustmentId,
    RespondPriceAdjustmentRequest body,
  ) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    ...
    final _options = _setStreamType<GenericResponse<PriceAdjustment>>(
      Options(method: 'POST', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
            '/tasks/${taskId}/price-adjustments/${adjustmentId}/respond',
            queryParameters: queryParameters,
            data: _data,
          )
          .copyWith(baseUrl: _combineBaseUrls(_dio.options.baseUrl, baseUrl)),
    ...
    final _result = await _dio.fetch<Map<String, dynamic>>(_options);
    late GenericResponse<PriceAdjustment> _value;
    try {
      _value = GenericResponse<PriceAdjustment>.fromJson(
        _result.data!,
        (json) => PriceAdjustment.fromJson(json as Map<String, dynamic>),
      );
    } on Object catch (e, s) {
      errorLogger?.logError(e, s, _options, _result);
      rethrow;
  ...
  @override
  Future<GenericResponse<PriceAdjustment>>
  getRecentPendingPriceAdjustment() async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
    final _options = _setStreamType<GenericResponse<PriceAdjustment>>(
      Options(method: 'GET', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
            '/tasks/price-adjustments/recent',
            queryParameters: queryParameters,
            data: _data,
          )
          .copyWith(baseUrl: _combineBaseUrls(_dio.options.baseUrl, baseUrl)),
