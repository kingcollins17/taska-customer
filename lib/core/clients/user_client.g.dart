...
class _UserClient implements UserClient {
  ...
  @override
  Future<GenericResponse<dynamic>> registerUser(RegisterRequest request) async {
  ...
  @override
  Future<GenericResponse<User>> getMe() async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
    final _options = _setStreamType<GenericResponse<User>>(
  ...
  Future<GenericResponse<BankAccountVerification>> verifyBankAccount(
    ...
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
    final _options = _setStreamType<GenericResponse<BankAccountVerification>>(
      Options(method: 'GET', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
    ...
    final _result = await _dio.fetch<Map<String, dynamic>>(_options);
    late GenericResponse<BankAccountVerification> _value;
    try {
      _value = GenericResponse<BankAccountVerification>.fromJson(
        _result.data!,
        (json) =>
            BankAccountVerification.fromJson(json as Map<String, dynamic>),
      );
    } on Object catch (e, s) {
      errorLogger?.logError(e, s, _options, _result);
      rethrow;
  ...
  @override
  Future<GenericResponse<List<SupportedBank>>> getSupportedBanks() async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
    final _options = _setStreamType<GenericResponse<List<SupportedBank>>>(
      Options(method: 'GET', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
            '/users/payouts/banks',
    ...
    final _result = await _dio.fetch<Map<String, dynamic>>(_options);
    late GenericResponse<List<SupportedBank>> _value;
    try {
      _value = GenericResponse<List<SupportedBank>>.fromJson(
        _result.data!,
  ...
  Future<GenericResponse<PublicProviderProfile>> getPublicProviderProfile(
    ...
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
    final _options = _setStreamType<GenericResponse<PublicProviderProfile>>(
      Options(method: 'GET', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
    ...
    final _result = await _dio.fetch<Map<String, dynamic>>(_options);
    late GenericResponse<PublicProviderProfile> _value;
    try {
      _value = GenericResponse<PublicProviderProfile>.fromJson(
        _result.data!,
        (json) => PublicProviderProfile.fromJson(json as Map<String, dynamic>),
      );
    } on Object catch (e, s) {
      errorLogger?.logError(e, s, _options, _result);
      rethrow;
